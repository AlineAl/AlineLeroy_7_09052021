<template>
    <div class="container">
        ...
        <div class="card-display-article"> 
            <form action="http://localhost:3000/api/articles/edit" method="put">
                <p class="add-image"><i class="fas fa-images"></i> <i class="fas fa-plus" id="add"></i></p>
                <p class="display-none">Ajouter une image</p>
                <div>
                    <input v-model="this.title" class="form-title-content" type="text" id="titre" name="titre" placeholder="Nouveau titre" required>  
                </div>
                <div>
                    <input v-model="this.content" lass="form-title-content" id="content" type="text" name="contenu" placeholder="Nouveau message" required>  
                </div>
